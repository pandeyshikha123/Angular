...
- Create Angular project with ng: `ng new angularappcode.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularappcode.client.esproj`).
